<footer class="bg-gradient-to-br from-emerald-800 to-teal-500 text-gray-100 mt-16">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 py-12 grid gap-8 md:grid-cols-3">
        ...
        <div>
            ...
            <ul class="space-y-2 text-sm">
                ...
                <li><a href="<?php echo e(route('struktur')); ?>" class="hover:text-white">Struktur Organisasi</a></li>
                <li><a href="<?php echo e(route('galeri')); ?>" class="hover:text-white">Galeri</a></li>
                <li><a href="<?php echo e(route('tentang')); ?>" class="hover:text-white">Tentang Desa</a></li>
            </ul>
        </div>
    ...
    <div class="border-t border-white/20 py-4 text-center text-xs text-gray-200">
        &copy; <?php echo e(date('Y')); ?> <?php echo e(config('app.name')); ?>. Dibangun dengan Laravel.
    </div>
</footer><?php /**PATH C:\xampp\htdocs\desa-citali\resources\views/partials/footer.blade.php ENDPATH**/ ?>