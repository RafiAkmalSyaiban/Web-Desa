...
<?php $__env->startSection('title', 'Jalur Pengajuan - ' . config('app.name')); ?>
        ...
        <section>
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
                ...
                <div class="rounded-2xl border border-gray-100 bg-white shadow-sm p-6">
                    ...
                    <a href="<?php echo e(route('tentang')); ?>" class="text-sm font-semibold text-primary-700 hover:underline">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\desa-citali\resources\views/pengajuan/jalur.blade.php ENDPATH**/ ?>