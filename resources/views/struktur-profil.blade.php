...
@section('title', $item['nama'] . ' - ' . config('app.name'))
        ...
        <div class="relative max-w-2xl mx-auto px-4 sm:px-6">
            ...
            <div class="bg-white rounded-3xl shadow-xl shadow-primary-900/5 border border-primary-100/60 overflow-hidden">
                ...
                <div class="px-6 sm:px-10 pb-8 pt-10 text-center">
                    ...
                    <h1 class="text-2xl sm:text-3xl font-bold text-gray-800 mt-5">{{ $item['nama'] }}</h1>
                    <span
                ...
                <div class="px-6 sm:px-10 pb-10">
                    <div class="grid sm:grid-cols-3 gap-4 max-w-xl mx-auto">
                        ...
                        <div
                            ...
                            <p class="text-sm font-semibold text-gray-700">{{ $item['ttl'] }}</p>
                        </div>
                        ...
                        <div
                            ...
                            <p class="text-sm font-semibold text-gray-700">{{ $item['pendidikan'] }}</p>
                        </div>
                        ...
                        <div
                            ...
                            <p class="text-sm font-semibold text-gray-700">{{ $item['alamat'] }}</p>
                        </div>
