<header class="bg-gradient-to-r from-emerald-800 to-teal-500 shadow-sm sticky top-0 z-50">
    <nav class="max-w-6xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between">
        ...
        <ul id="navMenu" class="hidden md:flex items-center gap-6 text-sm font-medium">
            <li><a href="{{ route('home') }}" class="text-white/90 hover:text-white {{ request()->routeIs('home') ? 'text-white font-semibold' : '' }}">Home</a></li>
            <li><a href="{{ route('berita.index') }}" class="text-white/90 hover:text-white {{ request()->routeIs('berita.*') ? 'text-white font-semibold' : '' }}">Berita</a></li>
            <li><a href="{{ route('struktur') }}" class="text-white/90 hover:text-white {{ request()->routeIs('struktur') ? 'text-white font-semibold' : '' }}">Struktur Organisasi</a></li>
            <li><a href="{{ route('galeri') }}" class="text-white/90 hover:text-white {{ request()->routeIs('galeri') ? 'text-white font-semibold' : '' }}">Galeri</a></li>
            <li><a href="{{ route('tentang') }}" class="px-4 py-2 rounded-full bg-white text-primary-700 hover:bg-primary-50 {{ request()->routeIs('tentang') ? 'ring-2 ring-white/60' : '' }}">Tentang Desa</a></li>
        </ul>
    </nav>
    ...
    <ul id="navMenuMobile" class="hidden md:hidden flex-col gap-1 px-4 pb-4 text-sm font-medium bg-gradient-to-r from-emerald-800 to-teal-500">
        ...
        <li><a href="{{ route('struktur') }}" class="block py-2 text-white/90 hover:text-white">Struktur Organisasi</a></li>
