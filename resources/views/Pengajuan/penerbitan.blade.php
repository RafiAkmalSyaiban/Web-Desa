...
@section('title', 'Pengajuan Penerbitan Surat - ' . config('app.name'))
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 py-12 space-y-16">
        ...
        <section>
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                @foreach ($jenisSurat as [$judul, $desk])
        ...
        <div class="grid md:grid-cols-2 gap-10">
            ...
            <section>
                ...
                <ul class="space-y-3">
                    @foreach (['Fotokopi KTP pemohon', 'Fotokopi Kartu Keluarga (KK)', 'Surat pengantar RT/RW', 'Dokumen pendukung sesuai jenis surat (jika ada)'] as $syarat)
            ...
            <section>
                ...
                <ol class="space-y-4">
                    @foreach (['Siapkan dokumen persyaratan', 'Isi formulir pengajuan di bawah', 'Verifikasi oleh petugas desa', 'Surat selesai & dapat diambil di kantor desa'] as $i => $langkah)
