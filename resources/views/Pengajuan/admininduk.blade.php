...
@section('title', 'Pengajuan Adminduk - ' . config('app.name'))
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 py-12 space-y-16">
        ...
        <div class="grid md:grid-cols-2 gap-10">
            ...
            <section>
                ...
                <ul class="space-y-3">
                    @foreach (['Fotokopi KTP dan Kartu Keluarga (KK) asli', 'Dokumen pendukung sesuai jenis layanan (akta, surat nikah, dll)', 'Surat pengantar dari RT/RW', 'Materai (jika diperlukan)'] as $syarat)
            ...
            <section>
                ...
                <ol class="space-y-4">
                    @foreach (['Siapkan dokumen persyaratan sesuai jenis layanan', 'Isi formulir pengajuan secara online', 'Verifikasi berkas oleh petugas desa', 'Data diproses & diteruskan ke Disdukcapil bila diperlukan'] as $i => $langkah)
